	...
	var init = function( hash ){
		...
		Util.loadImg( function(){	
			...
			Util.loadAudio( function(){
				...
				//游戏按键说明
				div.innerHTML = '<p><h6>主机按键：1、移动-- W: 上, D: 前, A: 后, S：下    &nbsp;&nbsp;&nbsp;    2、攻击-- J: 轻拳, K: 重拳, U: 轻腿, I: 重腿    &nbsp;&nbsp;&nbsp;    3、技能连招--下→前→拳: 波动拳, 下→后→腿：旋风腿, 前→下→前→拳：升龙拳</h6></p><p><h6>副机按键：1、移动-- ↑: 上, ←: 前, →: 后, ↓：下    &nbsp;&nbsp;&nbsp;    2、攻击-- 1: 轻拳, 2: 重拳, 4: 轻腿, 5: 重腿    &nbsp;&nbsp;&nbsp;    3、技能连招-- 下→前→拳: 波动拳, 下→后→腿：旋风腿, 前→下→前→拳：升龙拳</h6></p><p><h6>按F2暂停游戏, 1键大战电脑ai, 2键双人对打</h6></p>'
